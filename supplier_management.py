...
suppliers_data = [
    {"sid": "S0001", "name": "ABC Company", "poc": "Shiela Reyes", "contact": "(503) 555-0142",
        "address": "Makati City, PH", "email": "abcco@brewtrack.com", "status": "Active"},
    {"sid": "S0002", "name": "ZXC Farm", "poc": "Xi Tan", "contact": "(503) 555-0142",
        "address": "Taguig City, PH", "email": "zxcfarm@brewtrack.com", "status": "Active"},
]


def build_suppliers_table():
    rows = [table_header_row()] + [
        supplier_row(item["sid"], item["name"], item["poc"], item["contact"],
                     item["address"], item["email"], item["status"])
